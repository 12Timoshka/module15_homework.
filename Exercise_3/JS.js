...
let websocket = new WebSocket(wsUri); 
	...
	websocket.onmessage = function(evt) {
		writeToScreen(`servers answer: ${evt.data}`, 'flex-start');
	};
...
const error = () => {
	let textErr0r = 'Its imposible to get your geolocation';
...
btnGeo.addEventListener('click', () => {
	if (!navigator.geolocation) {
	  console.log('Your browser doesnt support the Geolocation');
	} else {
